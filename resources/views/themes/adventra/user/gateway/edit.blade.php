                        ...
                        <div class="d-grid gap-3 gap-lg-5">
                            <div class="card">
                                ...
                                <div class="card-body mt-2">
                                    <form action="{{ route('user.payment.gateway.edit',$method->id) }}" method="post"
                                                                ...
                                                                <td>
                                                                    <div class="input-group mb-1">
                                                                        ...
                                                                        <input type="text"
                                                                               ...
                                                                               autocomplete="off">
                                                                        <span class="input-group-text">{{ old("receivable_currencies.$i.name", $method->currency_type == 1 ? $method->receivable_currencies[$i]->name : 'USD') }}</span>
    ...
    <div class="modal fade" id="autoUpdateCurrencyModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.payment.method.auto.update.currency', $method->id) }}" method="post">
                    @csrf
