                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="input-group">
                                            <input type="number" placeholder="Discount" name="discount" value="{{ old('discount') }}" class="form-control" autocomplete="off">
                                            <div class="input-group-append">
                                                <select
                                                    ...
                                                    <option value="0">{{ basicControl()->base_currency }}</option>
                                                </select>
                                            </div>
                                            <div class="invalid-feedback d-inline-block">
                            ...
                            <div class="form-group mb-3 mt-3">
                                <button type="submit" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle pe-1"></i>@lang('Save')</button>
                            </div>
                        </div>
                    </div>
                </div>
