<div id="stepImages" class="step-content-section d-none">
    ...
    <div class="card mb-3 mb-lg-5">
        <div class="card-body">
            <label class="form-label" for="destinationThumbnail">@lang('Destination Thumbnail')<span class="text-danger ps-1">*</span></label>
    ...
    <div class="card mb-3 mb-lg-5">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <label for="image" class="form-label">@lang('Package Images')<span class="text-danger ps-1">*</span></label>
    ...
    <div class="bottom-area">
        ...
        <button type="submit" class="btn btn-primary btn-sm packageUpdateSubmit">@lang("Update")<i class="bi-check-circle ps-1"></i></button>
    </div>
</div>
@push('style')
