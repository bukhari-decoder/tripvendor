                                                    ...
                                                    <a class="d-flex align-items-center" href="javascript:void(0)">
                                                        <div class="avatar avatar-circle">
                                                            <img class="avatar-img"
                                                                 src="{{ getFile(optional($payment->gatewayable)->driver, optional($payment->gatewayable)->image) }}"
                                                                 alt="Image Description">
                                                        </div>
                                                        <div class="ms-3">
                                                            <span
                                                                class="d-block h5 text-inherit mb-0">@lang(optional($payment->gatewayable)->name)</span>
                                                        </div>
                                                    </a>
                                                </td>
                                                <td>
