    ...
    <div class="content container-fluid">
        ...
        <div class="alert alert-soft-dark mb-5" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <div class="d-flex align-items-center">
                        <p class="mb-0 text-body">@lang("You are editing page for `$pageEditableLanguage->name` version in `".stringToTitle($theme)."`")</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route("admin.update.page", [$page->id, $theme]) }}" method="post"
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="d-grid gap-3 gap-lg-5">
                        <div class="card order-lg-0 order-3">
                            <div class="card-header">
                        ...
                        <div class="card order-lg-1 order-2 language_card">
                            <div class="card-header">
                        ...
                        <div class="card order-lg-2 order-1 ">
                            <div class="card-header">
                        ...
                        <div class="card order-lg-3 order-0">
                            <div class="card-header">
