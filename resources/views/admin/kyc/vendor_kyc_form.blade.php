...
@section('page_title', __('Vendor KYC'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Vendor KYC')</li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('Vendor KYC Form')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Vendor KYC Form')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card pb-3">
                        ...
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.vendor.kyc.store') }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <span class="col-4 col-sm-9 ms-0 ">
                                          <span class="d-block text-dark">@lang("KYC Status")</span>
                                              <span class="d-block fs-5">@lang("Enable KYC status for your user to obtain their information.")</span>
                                            </span>
                                                    <span class="col-2 col-sm-3 text-end">
                                                        <input type='hidden' value='0' name='status'>
                                                        <input class="form-check-input @error('status') is-invalid @enderror"
                                                               type="checkbox" name="status" id="kycStatusSwitch" value="1" {{ ($kyc->status == 1) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12">
                                                <label class="row form-check form-switch mt-3" for="is_automatic">
                                                    <span class="col-4 col-sm-9 ms-0 ">
                                                      <span class="d-block text-dark">@lang("Autometic Approve")</span>
                                                      <span class="d-block fs-5">@lang("Set automatic KYC status for your vendor to approve autometically.")</span></span>
                                                        <span class="col-2 col-sm-3 text-end">
                                                            <input type='hidden' value='0' name='is_automatic'>
                                                            <input class="form-check-input @error('status') is-invalid @enderror"
                                                                   type="checkbox" name="is_automatic" id="kycStatusSwitch" value="1" {{ ($kyc->is_automatic == 1) ? 'checked' : '' }}>
                                                            <label class="form-check-label text-center" for="kycStatusSwitch"></label>
                                                        </span>
                                                    @error('is_automatic')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
