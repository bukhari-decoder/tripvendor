...
@section('page_title',trans('Package Booking'))
@section('content')

    <div class="content container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <x-page-header menu="Package Booking" :statBtn="true"/>
                                                ...
                                                <form id="filter_form">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 mb-4">
                                                            <span class="text-cap text-body">@lang('Tour Date Range')</span>
                                                            <div class="input-group mb-3 custom">
                                                                <input type="text" id="filter_date_range_tour"
                                                                       class="js-flatpickr form-control"
                                                                       placeholder="Select dates"
                                                                       data-hs-flatpickr-options='{
                                                                         "dateFormat": "d/m/Y",
                                                                         "mode": "range"
                                                                       }' aria-describedby="flatpickr_filter_date_range_tour">
                                                                                <span class="input-group-text" id="flatpickr_filter_date_range_tour">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 mb-4">
                                                            <span class="text-cap text-body">@lang('Tour Date Created Range')</span>
                                                            <div class="input-group mb-3 custom">
    ...
    <div class="modal fade" id="viewInformation" tabindex="-1" aria-labelledby="viewInformationLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="" id="acceptReject" method="GET">

                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn-danger rejectButton d-none" id="rejectBookingButton" data-bs-dismiss="modal" name="confirm" value="0">@lang('Reject')</button>
                        <button type="submit" class="btn btn-success acceptButton d-none" id="acceptBookingButton" data-bs-dismiss="modal" name="confirm" value="1">@lang('Accept')</button>
                    </div>
                </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.bookingView', function () {
                ...
                let acceptUrl = $this.data('accept_url');
                let statusBadge = '';
                ...
                if (status === 5) {
                    $('#acceptBookingButton, #rejectBookingButton').removeClass('d-none');
                } else {
                    $('#acceptBookingButton, #rejectBookingButton').addClass('d-none');
                }

                $('#acceptReject').attr('action', acceptUrl);
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("user.vendor.booking.list.search") }}",
                },
                columns: [
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                let filterTourDate = $('#filter_date_range_tour').val();

                const datatable = HSCore.components.HSDatatables.getItem(0);
                datatable.ajax.url("{{ route('user.vendor.booking.list.search') }}" + "?filterTransactionID=" + filterTransactionId + "&filterDate=" + filterDate+ "&filterTourDate=" + filterTourDate+ "&filterPackageTitle=" + filterPackageTitle).load();
            });
