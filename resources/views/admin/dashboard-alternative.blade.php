...
@section('content')
    <div class="content container-fluid dashboard-height">
        ...
        @include('admin.partials.dashboard.vendorActivity')
                    ...
                    @forelse($latestUser as $user)
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="d-block fs-5">{{ $user->phone_code.$user->phone }}</span>
                            </td>
                            <td>
                                {{ $user->country ?? 'N/A' }}
                            </td>
                            <td>
                                @if($user->role == 1)
                                    <span class="badge bg-soft-primary text-primary">
                                        <span class="legend-indicator bg-primary"></span>@lang("Vendor")
                                    </span>
                                @else
                                    <span class="badge bg-secondary text-light">
                                        <span class="legend-indicator bg-light"></span>@lang("User")
                                    </span>
                                @endif
                            </td>
                            <td>
