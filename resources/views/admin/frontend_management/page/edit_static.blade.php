        ...
        <div class="alert alert-soft-dark mb-5" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 ms-3">
                    <div class="d-flex align-items-center">
                        <p class="mb-0 text-body">@lang("You are editing static `$page->name` page for `$pageEditableLanguage->name` version in `".stringToTitle($theme)."`")</p>
                    </div>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-sm-auto">
                                                                <a class="text-secondary"
                                                                   href="{{ route('admin.edit.static.page', [$page->id, basicControl()->theme, $language->id]) }}"><i
