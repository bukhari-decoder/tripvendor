                                        ...
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h5 class="mb-0">@lang('Restrict User')</h5>
                                                        <span class="d-block fs-6 text-body">@lang('Enable this option to prevent the user from submitting any vendor requests.')</span>
                                                    </div>
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="row form-check form-switch mb-3" for="restrict_for_vendor_request">
                                                            <span class="col-4 col-sm-3 text-end">
                                                                ...
                                                                <input
                                                                    class="form-check-input @error('restrict_for_vendor_request') is-invalid @enderror"
                                                                    type="checkbox"
                                                                    name="restrict_for_vendor_request"
                                                                    id="restrict_for_vendor_request"
                                                                    value="1" {{ ($userKyc->user?->as_a_vendor_from == 1) ? 'checked' : '' }}>
                                                            </span>
                                                            @error('restrict_for_vendor_request')
                                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                                            @enderror
                                                        </label>
                                                    </div>
