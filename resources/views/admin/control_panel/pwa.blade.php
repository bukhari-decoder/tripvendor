                    ...
                    <div class="alert-box d-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center alertContent">
                                <p class="mb-0 text-body"> @lang('PWA (Progressive Web App) enables enhanced management of your sites’s settings and provides a seamless, app-like experience for users across devices.')</p>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                               ...
                                               autocomplete="off"
                                               value="{{ old('app_name', config('pwacontrol.app_name')) }}">
                                        @error('app_name')
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('short_name',config('pwacontrol.short_name')) }}">
                                        @error('short_name')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="color"
                                               ...
                                               value="{{ old('background_color',config('pwacontrol.background_color')) }}">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="color"
                                               ...
                                               value="{{ old('theme_color',config('pwacontrol.theme_color')) }}">
                                        @error('theme_color')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="tom-select-custom">
                                            <select
                                                ...
                                                <option
                                                    value="fullscreen" @selected(old('display',config('pwacontrol.display')) == 'fullscreen' )>@lang('Fullscreen')</option>
                                                <option
                                                    value="standalone" @selected(old('display',config('pwacontrol.display')) == 'standalone' )>@lang('Standalone')</option>
                                                <option
                                                    value="minimal-ui" @selected(old('display',config('pwacontrol.display')) == 'minimal-ui' )>@lang('Minimal Ui')</option>
                                                <option
                                                    value="browser" @selected(old('display',config('pwacontrol.display')) == 'browser' )>@lang('Browser')</option>
                                            </select>
                                        </div>
                                        @error('display')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="tom-select-custom">
                                            <select
                                                ...
                                                <option
                                                    value="default" @selected(old('status_bar',config('pwacontrol.status_bar')) == 'default' )>@lang('Default')</option>
                                                <option
                                                    value="black" @selected(old('status_bar',config('pwacontrol.status_bar')) == 'black' )>@lang('Black')</option>
                                                <option
                                                    value="black-translucent" @selected(old('status_bar',config('pwacontrol.status_bar')) == 'black-translucent' )>@lang('Black Translucent')</option>
                                            </select>
                                        </div>
                                        @error('display')
                                        <span class="invalid-feedback">{{ $message }}</span>
