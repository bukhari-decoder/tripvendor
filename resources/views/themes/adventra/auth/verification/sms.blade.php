            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="contact-container">
                        ...
                        <h4 class="mt-3 pt-4 text-center">@lang('Verify Your Phone')</h4>
                        <p class="mt-3 text-center">@lang("Your Phone Number is") {!! maskString(auth()->user()->phone) !!}</p>
                        <div class="contact-form">
                            <form action="{{ route('user.sms.verify') }}" method="post" class="php-email-form">
                                @csrf
                        ...
                        <div class="contact-form-footer">
                            <p>@lang('Didn\'t get Code? Click to') <a href="{{route('user.resend.code')}}?type=mobile"  class="text-info"> @lang('Resend code')</a></p>
                            @error('resend')
