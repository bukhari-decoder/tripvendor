...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{ route("admin.blog.update", [$blog->id, $language]) }}" method="post"
                    ...
                    <div class="d-grid gap-3 gap-lg-5">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if($defaultLanguage->id == $pageEditableLanguage->id)
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <span class="default-slug">{{ url('/') . '/blog-details' }}/
                                                <span id="editable-post-name">{{ $blog->slug }}</span>
                                            </span>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <label for="" class="form-label">@lang("Preview Image")</label>
                                        ...
                                        <h5>@lang('Image size should be') {{config('filelocation.blog.size')}} @lang('for better resolution')</h5>
