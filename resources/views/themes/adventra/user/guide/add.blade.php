...
@section('page_title',trans('Create Guide'))
@section('content')
                ...
                <div class="page-header custom-header">
                    <div class="row align-items-end">
                        <div class="col-sm mb-2 mb-sm-0">
                            ...
                            <h1 class="page-header-title">@lang('Create Guides')</h1>
                        </div>
                    </div>
                </div>
                <form action="{{ route('user.guide.store') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="card mb-3 mb-lg-5">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4 class="card-header-title">@lang('Add new Guide')</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="name" id="nameLabel" placeholder="e.g. Tom Curran" aria-label="name" value="{{ old('name') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="slug" id="slugLabel" placeholder="e.g. tom-curran" aria-label="slug" value="{{ old('slug') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="code" id="guideCodeLabel" placeholder="e.g. tom745 " aria-label="Code" value="{{ old('code') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="email" class="form-control" name="email" id="emailLabel" placeholder="e.g. tom745@gmail.com " aria-label="Email" value="{{ old('email') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="phone" id="phoneLabel" placeholder="e.g. +1 4855 854 255 " aria-label="Phone" value="{{ old('phone') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="years_of_experience" id="years_of_experienceLabel" placeholder="e.g. 5 " aria-label="Years of experience" value="{{ old('years_of_experience') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="tour_completed" id="tour_completedLabel" placeholder="e.g. 5 " aria-label="Total Completed tour" value="{{ old('tour_completed') }}">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="designation" id="designation" placeholder="e.g. Tour Guide " aria-label="Designation" value="{{ old('designation') }}">
