                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.basic.control.update') }}" method="post">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label for="adminPrefixLabel" class="form-label">@lang("Admin URL Prefix")</label>
                                        <input type="text"
                                    ...
                                    <div class="col-sm-6">
                                        <label for="freeListingLabel"
                                               class="form-label">@lang("Free Listing")</label>
                                        <input type="text"
                                               class="form-control @error('free_listing') is-invalid @enderror"
                                               name="free_listing" id="freeListingLabel"
                                               placeholder="@lang("Free Listing")"
                                               aria-label="@lang("Free Listing")"
                                               autocomplete="off"
                                               value="{{ old('free_listing', $basicControl->free_listing) }}">
                                        @error('free_listing')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <span class="d-block fs-6 text-body">
                                                        @lang('AI now helps you create tour packages faster and even generates custom images based on vendor requirements.')
                                                    </span>
                                                </div>
                                                <div class="col-auto">
                                                    <label class="row form-check form-switch mb-3" for="ai_feature">
                                                    <span class="col-4 col-sm-3 text-end">
                                                        <input type='hidden' value='0' name='ai_feature'>
                                                        <input
                                                            class="form-check-input @error('ai_feature') is-invalid @enderror"
                                                            type="checkbox"
                                                            name="ai_feature"
                                                            id="ai_feature"
                                                            value="1" {{($basicControl->ai_feature == 1) ? 'checked' : ''}}>
                                                        </span>
                                                        @error('ai_feature')
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <h5 class="mb-0">@lang('Gateway Auto Update Currency')</h5>
                                                    <span
                                                        class="d-block fs-6 text-body">@lang('This feature automates currency rate updates in a payment gateway.')</span>
                                                </div>
                                                <div class="col-auto">
                                                ...
                                                <span class="col-4 col-sm-3 text-end">
                                                    <input type='hidden' value='0' name='automatic_currency_update_permission'>
                                                        <input
                                                            class="form-check-input @error('automatic_currency_update_permission') is-invalid @enderror"
                                                            type="checkbox"
                                                            name="automatic_currency_update_permission"
                                                            id="automatic_currency_update_permission"
                                                            value="1" {{($basicControl->automatic_currency_update_permission == "1") ? 'checked' : ''}}>
                                                    </span>
                                                        @error('automatic_currency_update_permission')
                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                        @enderror
                                                    </label>
                                                </div>
