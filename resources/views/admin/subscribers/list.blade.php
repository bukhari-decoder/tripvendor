...
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Manage Subscribers" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("Today's Subscribe")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $subscribeRecord['todaySubscribe'] }}">{{ $subscribeRecord['todaySubscribe'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $subscribeRecord['totalSubscribe'] }}</span>
                                    <span class="badge bg-soft-success text-success ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($subscribeRecord['todaySubscribePercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("This Week's Subscribe")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $subscribeRecord['thisWeekSubscribe'] }}">{{ $subscribeRecord['thisWeekSubscribe'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $subscribeRecord['totalSubscribe'] }}</span>
                                    <span class="badge bg-soft-secondary text-secondary ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($subscribeRecord['thisWeekSubscribePercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("This Month's Subscribe")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $subscribeRecord['thisMonthSubscribe'] }}">{{ $subscribeRecord['thisMonthSubscribe'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $subscribeRecord['totalSubscribe'] }}</span>
                                    <span class="badge bg-soft-info text-info ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($subscribeRecord['thisMonthSubscribePercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("This Year's Subscribe")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $subscribeRecord['thisYearSubscribe'] }}">{{ $subscribeRecord['thisYearSubscribe'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $subscribeRecord['totalSubscribe'] }}</span>
                                    <span class="badge bg-soft-primary text-primary ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($subscribeRecord['thisYearSubscribePercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-body">
                            @lang('Do you want to delete all selected item?')
                        </div>
