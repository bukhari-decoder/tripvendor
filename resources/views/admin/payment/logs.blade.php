...
@section('content')
    <div class="content container-fluid">
        <x-page-header menu="Payment Logs" :statBtn="true"/>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                ...
                                <h3 class="card-title js-counter" data-value="{{ $paymentRecord[0]['todayPayment'] }}">{{ $paymentRecord[0]['todayPayment'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $paymentRecord[0]['totalPaymentLog'] }}</span>
                                    <span class="badge bg-soft-info text-info ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($paymentRecord[0]['todayPaymentPercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("Payment Success")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $paymentRecord[0]['paymentSuccess'] }}">{{ $paymentRecord[0]['paymentSuccess'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $paymentRecord[0]['totalPaymentLog'] }}</span>
                                    <span class="badge bg-soft-success text-success ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($paymentRecord[0]['paymentSuccessPercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("Pending Payment")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $paymentRecord[0]['pendingPayment'] }}">{{ $paymentRecord[0]['pendingPayment'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $paymentRecord[0]['totalPaymentLog'] }}</span>
                                    <span class="badge bg-soft-warning text-warning ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($paymentRecord[0]['pendingPaymentPercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-4">
                <div class="card card-hover-shadow h-100 stats-card">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <h6 class="card-subtitle mb-3">@lang("Canceled Payment")</h6>
                                <h3 class="card-title js-counter" data-value="{{ $paymentRecord[0]['cancelPayment'] }}">{{ $paymentRecord[0]['cancelPayment'] }}</h3>
                                <div class="d-flex align-items-center">
                                    <span class="d-block fs-6">@lang('from') {{ $paymentRecord[0]['totalPaymentLog'] }}</span>
                                    <span class="badge bg-soft-danger text-danger ms-2">
                                        <i class="bi-graph-up"></i> {{ number_format($paymentRecord[0]['cancelPaymentPercentage'], 2) }}%
                                    </span>
                                </div>
                            </div>
