...
class Payment
{
    public static function createPlan($gateway, $subscriptionPlan)
    {
        ...
        $productParams = [
            "name" => $subscriptionPlan->name ?? "abc",
        ...
        $postParams = [
            ...
            "billing_cycles" => [
                [
                    "frequency" => [
                        "interval_unit" => match ($subscriptionPlan->validity_type) {
                            'weekly' => 'WEEK',
                            'monthly' => 'MONTH',
                            'yearly' => 'YEAR',
                            default => 'MONTH',
    ...
    public static function ipn($request, $gateway, $deposit = null, $utr = null)
    {
        ...
        if ($apiRes->resource_type == 'subscription' && $apiRes->event_type == 'PAYMENT.SALE.COMPLETED') {
            ...
            $subsPurchase = PlanPurchase::where('api_subscription_id', $purchasePlanId)->first();
            if ($subsPurchase) {
